...
DEFINES += DEBUG_MAIN DEBUG IPSUM_DEBUG HTTP_DEBUG PACKET_DEBUG SENTPACKETS_DEBUG WS_DEBUG PACKET_LOGGING XML_DEBUG SQL_DEBUG CONFIG_DEBUG ZBSENDER_DEBUG
